export default function Contect() {
  ...
  const Contact = [
    ...
    { icon: "fa-solid fa-phone", heading: "Phone", para: "+91 9876543211 (General Inquiries)" },
  ];

  const Visit = [
    { college: "Keshav Mahavidyalaya university of Delhi", address: "H-4-5 Zone , pitampura Delhi-110034" },
  ];
  ...
  return (
    <section className="w-full flex flex-col justify-center items-center pb-10 py-20 relative bg-[#130520] z-20 px-4 sm:px-6 lg:px-8">
      ...
      <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold text-center">Contact <span className="text-yellow-500">Us</span></h1>
      ...
      <p className="text-center text-white text-lg sm:text-xl max-w-2xl mx-auto mb-10">
        Have a question about TRYST 2025? Reach out to us and we'll get back to you as soon as possible.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-5xl">
        ...
        <div className="p-6 bg-[#34005c] rounded-lg">
          <h1 className="text-yellow-500 text-2xl font-bold mb-2">Send us a message</h1>
          <p className="text-white mb-4">Fill out the form below and we'll respond to your query soon.</p>

          {/* Form */}
          <div className="flex flex-col gap-4">
            {Form.map((item) => (
              <div className="w-full">
                <label htmlFor={item.label} className="block text-white mb-1">{item.label}</label>
                <input
                  type="text"
            ...
            <div className="w-full">
              <label htmlFor="message" className="block text-white mb-1">Your Message</label>
              <textarea
                id="message"
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#34005c] p-6 rounded-lg">
            <h1 className="text-yellow-500 text-2xl font-bold mb-4">Contact Information</h1>
            {Contact.map((info) => (
