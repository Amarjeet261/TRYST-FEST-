    ...
    buttons: [
      {
        ...
        link: "#",
        style:
          "bg-yellow-500 text-black font-bold px-8 py-3 rounded-lg hover:bg-yellow-600 transition",
      },
      {
        text: "Learn More",
        link: "#",
        style:
          "bg-[#23003d] text-white font-bold px-8 py-3 rounded-lg hover:bg-[#35005d] transition",
      },
    ],
  };
  return (
    <>
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(to bottom right, rgba(0, 0, 0, 0.7), rgba(35, 0, 61, 0.7), rgba(102, 0, 51, 0.7)), url('https://vorlane.com/wp-content/uploads/2024/11/Concert-stage-setup-with-professional-lighting-LED-screens-sound-equipment-and-instruments-for-a-dynamic-live-performance.webp')",
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center w-full h-full gap-6  ">
          <h1 className="text-4xl sm:text-5xl  md:text-6xl lg:text-7xl font-bold  flex items-center text-white gap-5 text-center  ">
            <span className="text-yellow-500 font-bold animate-pulse drop-shadow-[0px_0px_10px_rgb(255,193,7)]">
              {Datas.title.split(" ")[0]}
            </span>{" "}
            {Datas.title.split(" ")[1]}
          </h1>
